...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO book (isbn, title, author, edition, publisher, publication_year, no_of_pages, language, quantity, category, subcategory, image, donated_by) 
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            // SQL query
            $sql = "SELECT * FROM view_donations WHERE donated_by = '$email'";
